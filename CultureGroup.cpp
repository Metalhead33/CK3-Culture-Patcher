...
QDoubleStringList &CultureGroup::getMercenaryNames()
{
	return mercenaryNames;
}

const QDoubleStringList& CultureGroup::getMercenaryNames() const
{
	return mercenaryNames;
}

void CultureGroup::setMercenaryNames(const QDoubleStringList &value)
{
